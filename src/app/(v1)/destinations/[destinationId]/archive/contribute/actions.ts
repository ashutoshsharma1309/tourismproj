...
export async function submitContribution(
  ...
  try {
    ...
    /*
     * The archive this form feeds is Sikkim's, and this server action receives
     * only the form body — there is no destination in scope to thread. Named
     * explicitly rather than interpolated from a variable that does not exist.
     */
    revalidatePath("/destinations/sikkim/archive");
