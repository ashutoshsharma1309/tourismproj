...
const CAPABILITY = "responsible" as const;
...
export async function generateMetadata({
  ...
  return {
    ...
    alternates: { canonical: `/destinations/${destinationId}/responsible` },
    openGraph: {
      title: "Responsible travel in Sikkim",
      description:
      ...
      <JsonLd
        data={[
          articleSchema({
            ...
            url: `/destinations/${destinationId}/responsible`,
            section: "Responsible tourism",
          }),
          breadcrumbSchema([{ name: "Responsible travel", url: `/destinations/${destinationId}/responsible` }]),
        ]}
      />
