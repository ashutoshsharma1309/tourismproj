    ...
    rules: [
      {
        userAgent: "*",
        allow: "/",
        disallow: ["/admin/", "/login", "/signup", "/forgot-password", "/reset-password", "/account", "/partner/dashboard", "/partner/verification", "/partner/listings", "/partner/calendar", "/checkout/", "/search", "/auth/", "/api/"],
      },
    ],
