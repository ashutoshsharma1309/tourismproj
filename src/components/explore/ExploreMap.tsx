...
export function ExploreMap({
  ...
  const closeDetail = useCallback(() => {
    ...
    if (linkedId) router.replace("/destinations/sikkim/explore", { scroll: false });
        ...
        <div className="relative min-w-0">
          ...
          <p className="mt-3 flex flex-wrap items-center justify-between gap-3 text-small text-muted">
            ...
            {unmappedMonasteries > 0 ? (
              <Link href="/destinations/sikkim/preservation" className="text-caption text-subtle hover:text-primary">
