 ...
 *
 * THREE DESTINATIONS SHOW NOTHING HERE
 * ------------------------------------
 * Varanasi, Agra and Kyoto have no documented hotel articles at all. They
  ...
  return (
    <section id="stays" className="mt-14 scroll-mt-20">
      ...
      <p className="mt-2 max-w-2xl text-body text-muted">
        Properties with a published record, quoted from the source cited beneath
        each. A website or telephone number appears only where a source
        publishes one. Nothing here is priced, rated or bookable: this product
        has no licensed feed for any of that, and a guess would be worse than a
        gap.
      </p>
      ...
      <ul className="mt-6 grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
        {/* Twelve is the published ceiling for a curated stays section — an
            ...
            the slice is the guarantee at the surface. */}
