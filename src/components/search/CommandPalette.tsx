...
import { BedDouble, Compass, Landmark, Mountain, Search } from "lucide-react";
...
interface SearchItem {
  ...
  sublabel: string;
  href: string;
  group: "Monasteries" | "Places" | "Stays" | "Go to";
  icon: LucideIcon;
}
...
function buildIndex(): SearchItem[] {
  ...
  items.push(
    ...
    { label: "Heritage map", sublabel: "Every site on one map", href: "/#map", group: "Go to", icon: Compass },
...
const GROUP_ORDER: SearchItem["group"][] = ["Monasteries", "Places", "Stays", "Go to"];
      ...
      <div className="animate-scale-in relative w-full max-w-xl overflow-hidden rounded-xl border bg-surface shadow-overlay">
        <div className="flex items-center gap-3 border-b px-4">
          ...
          <input
            ...
            placeholder="Search monasteries, places and stays…"
            aria-label="Search"
