...
/*
 * The link was hardcoded to /destinations/sikkim/. Sikkim's stories do not
 * carry a destinationId (they predate the registry); the 178 capsule stories
 * do, and every "Keep going" rail on their pages was sending readers into
 * Sikkim's archive. A story that knows its destination links to it; one that
 * does not is Sikkim's.
 */
export function StoryCard({
  ...
  return (
    <Link
      href={`/destinations/${("destinationId" in story && story.destinationId) || "sikkim"}/stories/${story.slug}`}
