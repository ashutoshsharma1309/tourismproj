...
const en = {
  ...
  /* plan */
  "plan.title": "Plan",
  "plan.lede": "What your plan includes and how much of it you use. Plans are set by TerraStory reviewers: online billing is not enabled, and nothing is charged.",
  "plan.current": "Current plan",
  "plan.state.DEFAULT": "The default plan for every partner.",
  "plan.state.TRIALING": "Trial until {date}.",
  "plan.state.ACTIVE": "Active.",
  "plan.state.ACTIVE.until": "Active until {date}.",
  "plan.state.PAST_DUE_GRACE": "Renewal is overdue; the plan still applies until {date}.",
  "plan.state.CANCELLING": "Ends on {date} and will not renew.",
  "plan.state.LAPSED": "Your {plan} subscription has ended, so the {current} plan applies. Everything you created is kept.",
  "plan.usage": "Usage",
  "plan.usage.listings": "Listings",
  "plan.usage.roomTypes": "Room types on your largest listing",
  "plan.usage.team": "Team members",
  "plan.of": "{used} of {limit}",
  "plan.unlimited": "{used}, no plan limit",
  "plan.features": "Included",
  "plan.feature.createListing": "Add listings",
  "plan.feature.manageInventory": "Rooms, rates and calendar",
  "plan.feature.viewAnalytics": "Analytics",
  "plan.feature.addTeamMembers": "Team members",
  "plan.feature.advancedReports": "Exportable reports",
  "plan.all": "All plans",
  "plan.price": "{amount} a month (proposed)",
  "plan.free": "No charge",
  "plan.priceNote": "Prices are proposals from TerraStory's business analysis. Online billing is not enabled; to change plan, ask a TerraStory reviewer.",
  "plan.yours": "Your plan",
  "plan.limit.listings": "Up to {count} listings",
  "plan.limit.listingsOne": "1 listing",
  "plan.limit.roomTypes": "Up to {count} room types per listing",
  "plan.limit.team": "Up to {count} team members",
  "plan.locked": "{feature} is part of the {plan} plan.",
  "plan.lockedCta": "See plans",
  "plan.limitReached": "Your {plan} plan's limit is reached. Everything you already have stays; to add more, ask a reviewer to change your plan.",

  /* analytics */
  "analytics.title": "Analytics",
  "analytics.lede": "How travellers reached your listings and what your calendar holds. Every figure counts real events; nothing is estimated.",
  "analytics.clicks": "Clicks to your channels, last 30 days",
  "analytics.holds": "Reservations started, last 30 days",
  "analytics.released": "of which released or expired",
  "analytics.open": "Room-nights open, next 30 days",
  "analytics.held": "Room-nights held, next 30 days",
  "analytics.booked": "Room-nights booked, next 30 days",
  "analytics.empty": "No listings yet, so nothing to measure.",
  "analytics.noRevenue": "Revenue appears here once payments are connected. No payment has been taken.",
  "analytics.report": "Download reservations (CSV)",
  "analytics.reportLocked": "Exportable reports are part of the {plan} plan.",

  /* team */
  "team.title": "Team",
  "team.lede": "People who work in this workspace with you. They sign in with their own e-mail and see the same listings, rooms and calendar. Only the owner manages the team.",
  "team.empty": "No team members yet.",
  "team.add": "Add team member",
  "team.email": "Their e-mail address",
  "team.adding": "Adding…",
  ...
  "team.ownerOnly": "Only the owner can add or remove team members.",
  ...
  "error.planFeature": "Your plan does not include this. See Plan for what each plan includes.",
  "error.planLimit": "You have reached your plan's limit for this. See Plan for what each plan includes.",
  "error.ownerOnly": "Only the organisation's owner can do this.",
  "error.memberEmail": "Enter the e-mail address the team member signs in with.",
  "error.memberExists": "That person already belongs to a partner organisation.",
