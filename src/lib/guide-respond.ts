...
export type GuideItemKind = "monastery" | "place" | "story" | "stay";
  ...
  if (hasAny(q, PERMIT_WORDS)) {
    ...
    return {
      blocks: [
        ...
        { kind: "link", href: "/permits", label: "Read the department's permit rules" },
        {
          kind: "note",
    ...
    if (gap) {
      return {
        blocks: [
          ...
          { kind: "link", href: "/hotels", label: "See the register instead" },
        ],
      };
    }
  }
  ...
  if (hasAny(q, FEE_WORDS) || hasAny(q, MONEY_WORDS)) {
    return {
      blocks: [
        ...
        { kind: "link", href: "/hotels", label: "How the fee works" },
      ],
    };
  }
  ...
  if (hasAny(q, AUDIO_WORDS)) {
    ...
    return {
      blocks: [
        ...
        { kind: "link", href: "/monasteries", label: "Browse the monasteries" },
      ],
    };
  }
  ...
  if (hasAny(q, STAY_WORDS)) {
    ...
    return {
      blocks: [
        ...
        { kind: "link", href: "/hotels", label: "See the full register" },
      ],
    };
  }
  ...
  if (hasAny(q, MONASTERY_WORDS) || tradition) {
    ...
    if (matches.length === 0) {
      return {
        blocks: [
          ...
          { kind: "link", href: "/monasteries", label: "Browse all monasteries" },
        ],
      };
    }
    ...
    return {
      blocks: [
        ...
        { kind: "link", href: "/monasteries", label: "Open the explorer" },
      ],
    };
  }
    ...
    if (chosen.length > 0) {
      return {
        blocks: [
          ...
          { kind: "link", href: "/explore", label: "See them on the map" },
        ],
      };
    }
  }
    ...
    if (matches.length > 0) {
      return {
        blocks: [
          ...
          { kind: "link", href: "/stories", label: "Browse all stories" },
        ],
      };
    }
  }
